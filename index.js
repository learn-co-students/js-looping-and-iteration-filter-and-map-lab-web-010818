...
function driverNamesWithRevenueOver(drivers, revenue) {
  driverNames = driversWithRevenueOver(drivers, revenue).map(function (driver) {return driver.name})
  return driverNames
}
...
function exactMatchToList(drivers, attribute) {
  driverNames = exactMatch(drivers, attribute).map(function (driver) {return driver.name})
  return driverNames
}
